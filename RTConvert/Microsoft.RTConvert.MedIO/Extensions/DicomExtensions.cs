...
namespace Microsoft.RTConvert.MedIO.Extensions
{
    ...
    public static class DicomExtensions
    {
        ...
        public static string GetStringOrEmpty(this DicomDataset ds, DicomTag tag)
        {
            ...
            return ds.GetSingleValueOrDefault<string>(tag, string.Empty);
        }
        ...
        {
            // Changed for new OSS fo-dicom-desktop
            return dcmset.GetSingleValueOrDefault<DicomUID>(DicomTag.SOPClassUID, EmptyUid) == DicomUID.RTStructureSetStorage;
        }
