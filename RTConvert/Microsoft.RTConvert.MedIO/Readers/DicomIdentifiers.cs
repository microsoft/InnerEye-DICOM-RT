    ...
    public class DicomIdentifiers
    {
        ...
        public static DicomIdentifiers ReadDicomIdentifiers(DicomDataset ds)
        {
            ...
            var allAsString = ds
                ...
                .Select((DicomItem x) => (Tag: x.Tag.DictionaryEntry.Name, Value: ds.GetString(x.Tag)))
                //.Select((DicomItem x) => (Tag: x.Tag.DictionaryEntry.Name, Value: ds.Get(x.Tag, string.Empty)))
                .ToList();
